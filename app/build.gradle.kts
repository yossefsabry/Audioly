...
android {
    namespace = "com.audioly.app"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.audioly.app"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
        ...
        // Only ship 64-bit native libs — halves APK size, covers all modern Android devices
        ndk {
            abiFilters += listOf("arm64-v8a", "x86_64")
        }

        buildConfigField("String", "APP_NAME", "\"Audioly\"")
    }
